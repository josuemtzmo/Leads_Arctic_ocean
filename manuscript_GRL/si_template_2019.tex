...
\title{Supporting Information for ``Is the surface forcing through sea ice leads transferred to the Arctic Ocean interior?"}
%
...
% 
%
\bibliography{biblio} %do not specify file extension
%
