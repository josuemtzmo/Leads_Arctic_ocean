...
In-situ observations have provided evidence that leads locally impact the ocean structure of the Arctic Ocean. However, the lack of observations limits an estimation of their integrated impact on the Arctic Ocean. Here, we present the first estimate of the impact of the leads in the Arctic Ocean, using a really high-resolution pan-Arctic hindcast, SEDNA \citep{SEDNA_2023}. Since the ice cover is dynamically and thermodynamically different in the marginal ice zone (MIZ) and the ice pack, we differentiate the leads in each region. Hereafter, we refer to leads as the union of the MIZ leads and the ice pack leads or LKFs. The impact of MIZ leads and ice pack LKFs is quantified by using buoyancy fluxes and the water mass transformation framework (See Methods for details of the calculations and numerical model). 
...
\begin{figure}
    ...
    \caption{Leads from SEDNA. a) Snapshot of the total deformation for the 21st of April 2014. b) Mean lead frequency between 2011 and 2015. c) True color image from Sentinel 3 on the 12th of April 2022 for the magenta area in panel a. d) Mean ice concentration from SEDNA on the 21st of April 2014. e) Total deformation used to identifies the leads. f) Mask of identified leads on the 21st of April 2014.\textbf{I changed the colorbar, is it better?}}
    \label{fig:fig1}
\end{figure}
...
\begin{figure}
    ...
    Transect on the 1st of January 2014 of c) downward heat flux, e) freshwater flux, g) ice thickness and mixed layer depth. b) Buoyancy flux in Summer the 25th of June 2014. Transect on the 25th of June 2014 of d) downward heat flux, f) freshwater flux, h) ice thickness (magenta) and buoyancy flux (green). Note that the transect location and orientation changes between the winter and summer dates. Magenta contour in panels a and e correspond to the 0\% concentration contour of sea ice. Vertical blue bars shows the mask of leads in the transect.}
    \label{fig:fig2}
\end{figure}
...
In other words, the extra heat exchanged with the atmosphere is used to form sea ice instead of further cooling the ocean, represented in the ocean-ice model as a heat flux close to zero at the ocean-ice-atmosphere interface. \josue{Is this clearer?}
...
In the Arctic ice covered ocean, the averaged percentage area covered by four distinct masks representative of the sea ice covered Arctic Ocean during 2014 is as follows: 19\% for the MIZ, 81\% for the ice pack, 14\% for the LKFs in the ice pack, and 10\% for the leads in the MIZ. 
...
In the MIZ, the buoyancy flux are in agreement with a preferential refreezing of sea ice during winter and melting in summer (Fig.\ref{fig:fig3}b), since thermal component is the dominant term and negative during winter and the haline component is the dominant term and positive during summer (Fig.\ref{fig:fig3}c). 
...
In both regions, the buoyancy flux in the leads follow the overall seasonal cycle of the buoyancy fluxes underneath the sea ice floes. However the winter leads in the MIZ and the summer LKFs in the ice pack exhibit larger buoyancy fluxes compared to those in the MIZ and ice pack, respectively. 
The mean winter buoyancy flux of the leads in the MIZ is 
-1.98 $\times10^{-14} m^2/s^3$, representing a 40\% larger buoyancy flux in winter within the leads compared to those in the MIZ, suggesting enhanced freezing within the leads. 
...
The yearly mean WMT in the ice pack LKFs also features a positive peak within the $24.5 < \rho <27.5$ reaching up to 0.39 Sv. On average the WMT in the ice pack LKFs accounts for $\sim 10\%$ of the WMT of the ice pack. The MIZ mean WMT is mostly negative within the density range of $20 < \rho < 27.5$ (gaining buoyancy), reaching a minimum of -1.2 Sv around $\rho = 27$.  The MIZ leads WMT is also negative within the same range of densities, with a minimum of -0.6 Sv. On average, the WMT in the MIZ leads corresponds to $\sim 50\%$ of the WMT of the MIZ. Additionally, the ice covered WMT, the sum of the WMT of the ice pack and the WMT of the MIZ, is comparable to the surface WMT reported by \citet{Pemberton_WMT_2015}.

A Hovmoller diagrams of the seasonal cycle of the WMT during 2014 for the ice covered Arctic, the ice pack, the MIZ, and leads in each of these regions are depicted in figure \ref{fig:fig4}.
...
The ice covered lead WMT also shows a seasonality, where the WMT is 0.27 Sv in winter and -0.85 Sv in summer (\ref{fig:fig4} c). leads in the ice covered Arctic contribute approximately 23\% of the WMT throughout the year. 
This contribution of leads can be decomposed into their contribution in the ice pack and the MIZ allowing us to better understand the evolution of the WMT. In winter, a positive transformation occurs (loss of buoyancy), due to brine rejection during sea ice growth. In summer, a negative transformation or a gain of buoyancy occurs due to the melting of sea ice. LKFs explain 10\% of the WMT in the ice pack, however, there is not a emergence of a pattern in the WMT ratios suggesting that LKFs transform different water masses than the water masses being transformed underneath the ice pack (\ref{fig:fig4} g). Second, the MIZ and the leads in this region present also a seasonal cycle, but the WMT is generally negative suggesting a gain of buoyancy due to melt of sea ice. leads in the MIZ explain approximately 50\% of the MIZ WMT, and similarly to the LKFs in the ice pack, no pattern emerges from the WMT rations that suggest a specific role of leads in the WMT compared to the WMT of the MIZ. 

\textbf{contrast between the ice pack and the MIZ. There is one to one ration between \% area and water mass transformation. }

\textbf{Clarify that the area changes following the ice cover, and make the distinction somewhere that we do not include convection areas in the Greenland Sea}

\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{./figures/Figure_4_water_mass_transformation_hovmoller_formation_V2.pdf}
    \caption{Mean and daily Water mass transformation over 2014. a) Mean water mass transformation over 2014 for the ice pack, MIZ, and leads in each region. Hovmoller diagram of the water mass transformation (Sv) for the b) ice pack, c) ice pack linear kinematic features and d) the ratio of water mass transformation between the LKFs and the ice pack region.
...
\textbf{Add discussion on where is the transformation happening.}
...
Using SEDNA, a high-resolution pan-Arctic hindcast, we found that leads, although covering less than 20\% of the sea-ice, can contribute up to 10\% more buoyancy fluxes at the ocean surface than the ice-pack. They also account for approximately 20\% of the total surface water mass transformation in the ice covered Arctic. Contrary to previous hypotheses, our findings suggest that buoyancy forcing through leads has a smaller contribution to Arctic Ocean dynamics than initially thought. While their presence can induce localized changes in the density of surface waters due to brine rejection and ice melting, their spatial extent and duration are not sufficient to significantly alter the surface water masses. Furthermore, both the transformation and formation of water masses in the leads have the same sign, and they are comparable to those underneath the surrounding ice floes. Thus, there is no evidence that leads act differently or that they have a particular imprint in the Arctic ocean water masses.
...
A discussed by \citealt{McPhee_LKF_2005}, leads generated by shear can significantly influence in the ocean MLD, by upwelling the isopycnals. Thus, to comprehensively understand the impact of leads on the ocean, we investigate the mixed layer depth, referenced to the first ocean model level, for each of the ice covered regions (Supplementary Fig.\ref{fig:S_fig2}). The MLD in the MIZ reaches a maximum depth in winter of $130 m$ and a minimum MLD of $1.62 m$ in summer. The MLD of the MIZ lead is comparable to that of the MIZ, reaching $127 m$ in winter and $1.67 m$ in summer. Meanwhile, the MLD in the ice pack and the ice pack LKFs are deeper in winter ($47.7 m$ and $40.5 m$, respectively) and shallower in summer ($1.9 m$ and $1.7 m$, respectively). The difference in MLD between the ice pack and ice pack LKF is significant and, on average, the MLD is $\sim 20\%$ shallower during winter in the ice pack LKFs. This results provides evidence that ice pack LKFs can impact MLD thickness through upwelling. 
...
It is important to note that some peaks in the buoyancy flux align with the edge of the detected LKFs, likely due to the enhanced refreezing or melting that occur at the edge of the LKFs. 

you probably want to:
- discuss your results by comapring against existing litterature (and actually reference papers, not just say 'previous study')
...
- i think the important bit is really teh contrast between the pack and the MIZ, not so much the total average
...
By separately diagnosing the density transformation that occurs in the leads and underneath the surrounding floes, we quantify the relative importance of the leads for each of these regions.
